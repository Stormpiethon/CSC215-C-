...
{ // This scope operator starts the function scope
	...
	// **************************   THIS IS THE BEGINNING FIRST PLAY   ***************************************
	...
	// ******************************   START OF PLAY AGAIN GAME   *******************************************

		// Main game loops starts here
	// Create a bool var to control the game loop.
	...
	if (playAgainChoice == "y" || playAgainChoice == "Y" || playAgainChoice == "yes" || playAgainChoice == "Yes")
	{
		...
		playAgain = true;
		std::cout << "\nLooks like you are up for another round!\n" << std::endl;
	}
	else
	{
		// we assume the user does not want to play again
		playAgain == false;
		std::cout << "\nLooks like you are done playing!\n" << std::endl;
	}
